...
class EchocardiographieType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('basalBullseye', BullseyeType::class)
            ...
            ->add('stressBullseye', BullseyeType::class)
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => Echocardiographie::class,
        ]);
    }
}
